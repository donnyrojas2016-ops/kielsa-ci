...
export default function middleware(request) {return next(); // TEMPORAL: bypass de Basic Auth a pedido de Donny (18-sep-2026). Para reactivar, borra esta línea. [forzar deploy]
